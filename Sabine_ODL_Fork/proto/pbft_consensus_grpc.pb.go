...
const (
	...
	PBFTConsensus_ReportLinkEvent_FullMethodName  = "/pbftconsensus.PBFTConsensus/ReportLinkEvent"
)
...
type PBFTConsensusClient interface {
	...
	ReportLinkEvent(ctx context.Context, in *LinkEventInfo, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *pBFTConsensusClient) ReportLinkEvent(ctx context.Context, in *LinkEventInfo, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, PBFTConsensus_ReportLinkEvent_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PBFTConsensusServer interface {
	...
	// Ryu Primary calls this to report a link event to be disseminated via PBFT
	ReportLinkEvent(context.Context, *LinkEventInfo) (*emptypb.Empty, error)
...
func (UnimplementedPBFTConsensusServer) ReportLinkEvent(context.Context, *LinkEventInfo) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ReportLinkEvent not implemented")
}
...
func _PBFTConsensus_ReportLinkEvent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(LinkEventInfo)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PBFTConsensusServer).ReportLinkEvent(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PBFTConsensus_ReportLinkEvent_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PBFTConsensusServer).ReportLinkEvent(ctx, req.(*LinkEventInfo))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PBFTConsensus_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ReportLinkEvent",
			Handler:    _PBFTConsensus_ReportLinkEvent_Handler,
		},
	},
...
const (
	...
	RyuReplicaLogic_NotifyLinkEvent_FullMethodName = "/pbftconsensus.RyuReplicaLogic/NotifyLinkEvent"
)
...
type RyuReplicaLogicClient interface {
	...
	NotifyLinkEvent(ctx context.Context, in *LinkEventInfo, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *ryuReplicaLogicClient) NotifyLinkEvent(ctx context.Context, in *LinkEventInfo, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, RyuReplicaLogic_NotifyLinkEvent_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RyuReplicaLogicServer interface {
	...
	// PBFT Node calls this to notify the replica of a consensus-agreed link event
	NotifyLinkEvent(context.Context, *LinkEventInfo) (*emptypb.Empty, error)
...
func (UnimplementedRyuReplicaLogicServer) NotifyLinkEvent(context.Context, *LinkEventInfo) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method NotifyLinkEvent not implemented")
}
...
func _RyuReplicaLogic_NotifyLinkEvent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(LinkEventInfo)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RyuReplicaLogicServer).NotifyLinkEvent(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RyuReplicaLogic_NotifyLinkEvent_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RyuReplicaLogicServer).NotifyLinkEvent(ctx, req.(*LinkEventInfo))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RyuReplicaLogic_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "NotifyLinkEvent",
			Handler:    _RyuReplicaLogic_NotifyLinkEvent_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "proto/pbft_consensus.proto",
